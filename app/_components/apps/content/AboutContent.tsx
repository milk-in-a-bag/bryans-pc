    ...
    <div className="p-8 text-white/90 font-sans">
      <div className="max-w-3xl flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3 text-sm leading-relaxed text-white/75">
          <p>
            Hey, I&apos;m Bryan — a fullstack developer who enjoys building
            clean, performant web applications from the ground up. I care about
            good architecture, great UX, and code that&apos;s easy to reason
            about.
          </p>
          <p>
            I work across the stack — designing APIs, building databases, and
            crafting interfaces that feel native. I&apos;m always exploring new
            tools and patterns to keep my work sharp.
          </p>
        </div>
